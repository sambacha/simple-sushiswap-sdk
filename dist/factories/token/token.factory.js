...
export class TokenFactory {
    constructor(_tokenContractAddress, _ethersProvider) {
        ...
        this._erc20TokenContracy = this._ethersProvider.getContract(JSON.stringify(ContractContext.erc20Abi), this._tokenContractAddress);
    }
    /**
    ...
    allowance(ethereumAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const allowance = yield this._erc20TokenContracy.allowance(ethereumAddress, ContractContext.routerAddress);
    ...
    getAllowanceAndBalanceOf(ethereumAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = contractCallResults.results[contractCallContext.reference];
            return {
                allowance: BigNumber.from(results.callsReturnContext[ALLOWANCE].returnValues[0]).toHexString(),
                balanceOf: BigNumber.from(results.callsReturnContext[BALANCEOF].returnValues[0]).toHexString(),
            };
        });
    }
}
