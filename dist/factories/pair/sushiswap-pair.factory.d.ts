...
export declare class SushiswapPairFactory {
    private _sushiswapPairFactoryContext;
    private readonly LIQUIDITY_PROVIDER_FEE;
    private _fromTokenFactory;
    private _SushiswapRouterContractFactory;
    private _sushiswapPairFactory;
    private _SushiswapRouterFactory;
    private _quoteChangeTimeout;
    private _quoteChanged$;
    constructor(_sushiswapPairFactoryContext: SushiswapPairFactoryContext);
    /**
     * The to token
     */
    get toToken(): Token;
     ...
     */
    get contractCalls(): SushiswapPairContractFactory;
    /**
