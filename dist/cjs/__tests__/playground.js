...
const sushiswap_pair_settings_1 = require("../factories/pair/models/sushiswap-pair-settings");
const sushiswap_pair_1 = require("../factories/pair/sushiswap-pair");
...
const routeTest = async () => {
    ...
    const sushiswapPair = new sushiswap_pair_1.SushiswapPair({
        fromTokenContractAddress,
        toTokenContractAddress,
        ethereumAddress,
        chainId: chain_id_1.ChainId.MAINNET,
        settings: new sushiswap_pair_settings_1.SushiswapPairSettings({
