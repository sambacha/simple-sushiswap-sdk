...
exports.SushiswapRouterFactory = void 0;
...
class SushiswapRouterFactory {
    ...
    async getAllPossibleRoutesWithQuotes(amountToTrade) {
    ...
    async findBestRoute(amountToTrade) {
        ...
        if (allRoutes.length === 0) {
            throw new sushiswap_error_1.SushiswapError(`No routes found for ${this._fromToken.contractAddress} > ${this._toToken.contractAddress}`, error_codes_1.ErrorCodes.noRoutesFound);
        }
        return {
            ...
            for (let i = 0; i < contractCallReturnContext.callsReturnContext.length; i++) {
                ...
                switch (tradePath) {
                    ...
                    case trade_path_2.TradePath.erc20ToErc20:
                        ...
                        break;
                    default:
                        throw new sushiswap_error_1.SushiswapError(`${tradePath} not found`, error_codes_1.ErrorCodes.tradePathIsNotSupported);
                }
            }
    ...
    formatAmountToTrade(amountToTrade) {
        switch (this.tradePath()) {
            ...
            default:
                throw new sushiswap_error_1.SushiswapError(`Internal trade path ${this.tradePath()} is not supported`, error_codes_1.ErrorCodes.tradePathIsNotSupported);
        }
    }
    /**
     * Get the trade path
    ...
    tradePath() {
        ...
        return (0, trade_path_1.getTradePath)(network.chainId, this._fromToken, this._toToken);
    }
    get allTokens() {
...
exports.SushiswapRouterFactory = SushiswapRouterFactory;
